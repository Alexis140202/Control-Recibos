    ...
    <div v-if="showModal" class="modal-overlay" @click.self="showModal = false">
      <div class="modal-content">
        ...
        <form @submit.prevent="guardarInquilino" class="form-grid">
          ...
          <div class="field"><label>📞 Teléfono</label><input type="tel" v-model="form.telefono" required /></div>
          <div class="field"><label>🪪 DNI</label><input type="text" v-model="form.dni" required /></div>
          <div class="field"><label>📧 Correo</label><input type="email" v-model="form.correo" required /></div>
